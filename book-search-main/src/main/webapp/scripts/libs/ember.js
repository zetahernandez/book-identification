...
*/
  ...
  @since Ember 0.9
*/
    Ember.Enumerable = Ember.Mixin.create( /** @scope Ember.Enumerable.prototype */ {
...
*/
  ...
  @extends Ember.Mixin
*/
    Ember.ControllerMixin = Ember.Mixin.create({ /* ducktype as a controller */
      isController: true,
...
class:
  ...
  * `dragEnd`
  ...
  @uses Ember.Evented
*/
    Ember.View = Ember.CoreView.extend( /** @scope Ember.View.prototype */ {
    ...
    Ember.Select = Ember.View.extend( /** @scope Ember.Select.prototype */ {
      ...
      defaultTemplate: Ember.Handlebars.template(function anonymous(Handlebars, depth0, helpers, partials, data) {
        ...
        function program3(depth0, data) {
          ...
          data.buffer.push(escapeExpression(helpers.view.call(depth0, "Ember.SelectOption", {
            hash: {
              'contentBinding': ("this")
            },
            contexts: [depth0],
