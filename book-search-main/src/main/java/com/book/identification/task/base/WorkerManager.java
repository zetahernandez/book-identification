...
public abstract class WorkerManager<P extends Work<IP>, IP extends ItemQueue, IC extends ItemQueue>
	...
	private Worker nextProducerConsumer;
	private	long startTime = 0;

	public WorkerManager(final String name, BlockingQueue<IC> input,
			BlockingQueue<IP> output, Worker nextProducerConsumer) {
		super(name);
		this.input = input;
		this.output = output;
